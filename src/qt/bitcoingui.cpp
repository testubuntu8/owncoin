    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Owncoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Owncoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and owncoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Owncoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Owncoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Owncoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Owncoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Owncoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a owncoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Owncoin Core help message to get a list with possible Owncoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Owncoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Owncoin network", "", count));
}
...
{
    QString strTitle = tr("Owncoin Core"); // default title
