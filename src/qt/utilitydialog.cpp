    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Owncoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Owncoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  owncoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Owncoin Core is shutting down...") + "<br /><br />" +
