...
Development
---------------------
The Dash repo's [root README](https://github.com/mycointest/owncoin/blob/master/README.md) contains relevant information on the development process and automated testing.
