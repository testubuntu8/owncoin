...
Only requiring some minor changes is owncoin.cpp.
...
Changes to owncoin.cpp
----------------------
owncoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
